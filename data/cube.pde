...
int wm = 200; // размер гиперкуба
int dim = 6; // кол-во кубиков
float gridSize = wm / dim;
float rescale = 0.3; // Размер кубиков (0.2 .. 1.0)
...
//int fig = 1; // Вид объекта (0 -, 1 box, 2 sphere, 3 mix)
